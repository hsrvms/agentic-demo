...
func (m *tenantMockService) Delete(_ context.Context, _ domain.TenantID) error {
	return nil
}

func (m *tenantMockService) IsAdmin(_ context.Context, _ domain.TenantID, _ uuid.UUID) (bool, error) {
	return true, nil
}
